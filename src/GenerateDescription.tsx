...
const getSecondSentence = (pronouns: PronounsObj): string => {
  ...
  sentences[15] = `A recent escapee of Devil's Island, ${pronouns.subjective} was now en route to Vassar under the alias of Maynard Basilisk to teach beekeeping.`
